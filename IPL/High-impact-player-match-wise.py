...
g1 = df[["match_id", "batsman"]] #all batsmans in a match
g2 = df[["match_id", "bowler"]] #all bowlers in a match
g1 = g1.append(g2)
...
df_players["points"] = (df_players["runs_scored"]/20 + df_players["wickets"])
